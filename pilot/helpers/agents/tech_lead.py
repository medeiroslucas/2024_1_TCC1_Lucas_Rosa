...
class TechLead(Agent):
    ...
    def get_development_plan(self, main_description: str, project_specs: str, architecture: str) -> Dict:
        ...
        conversational_agent.append_prompt_to_messages("schemas/development_plan_json_schema.prompt")
